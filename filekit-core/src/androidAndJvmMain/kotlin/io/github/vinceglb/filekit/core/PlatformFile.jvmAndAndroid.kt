...
public actual open class PlatformFile : IPlatformFile {
    ...
    public actual constructor(parent: PlatformFile, child: String) {
    ...
    public actual override suspend fun readBytes(): ByteArray =
        withContext(Dispatchers.IO) { wrappedFile.readBytes() }

    @Deprecated("Use getLength() instead")
    public actual override fun getSize(): Long? = Files.size(wrappedFile.toPath())
}

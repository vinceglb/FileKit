...
public actual open class PlatformFile(
	...
	actual override fun getSize(): Long? = file.size.toDouble().toLong()
	...
	actual override suspend fun getLength(): Long = file.size.toDouble().toLong()
	...
	public actual constructor(pathName: String) : this(File(JsArray(), "")) {
		error("Unsupported")
	}

	public actual constructor(parent: String, child: String) : this(File(JsArray(), "")) {
		error("Unsupported")
	}

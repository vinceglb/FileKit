...
actual fun ShareFileSection(
    ...
    var authority by remember { mutableStateOf(FileKitShareSettings.createDefault().authority) }

    val launcher = key(authority) {
        rememberShareFileLauncher(
            shareSettings = FileKitShareSettings(authority = authority),
        )
    }
